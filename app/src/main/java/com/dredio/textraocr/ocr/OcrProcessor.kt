...
import com.dredio.textraocr.AppDiagnostics
...
class OcrProcessor(
    ...
    suspend fun processSession(
        ...
        preprocessingOptionsByPage: Map<Int, OcrPreprocessingOptions> = emptyMap()
    ): OcrSessionResult = withContext(Dispatchers.Default) {
        ...
        imageUris.forEachIndexed { index, uriString ->
            ...
            val preprocessingOptions = preprocessingOptionsByPage[pageNumber] ?: OcrPreprocessingOptions()
    ...
    suspend fun processPage(
        ...
        preprocessingOptions: OcrPreprocessingOptions = OcrPreprocessingOptions()
    ...
    private suspend fun processSinglePage(
        ...
        val preprocessResult = runCatching {
            imagePreprocessor.preprocess(uri, preprocessingOptions)
        }.getOrElse { throwable ->
            AppDiagnostics.logBreadcrumb(
                context,
